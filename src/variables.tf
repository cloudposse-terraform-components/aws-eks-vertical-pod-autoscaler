...
variable "recommender_resources" {
  ...
  description = "The cpu and memory of the VPA recommender's limits and requests."
  default = {
    limits = {
      cpu    = "200m"
      memory = "1000Mi"
...
variable "updater_resources" {
  ...
  description = "The cpu and memory of the VPA updater's limits and requests."
  default = {
    limits = {
      cpu    = "200m"
      memory = "1000Mi"
...
variable "admission_controller_resources" {
  ...
  description = "The cpu and memory of the VPA admission controller's limits and requests."
  default = {
    limits = {
      cpu    = "200m"
      memory = "500Mi"
...
variable "admission_controller_enabled" {
  type        = bool
  description = "Enable VPA admission controller. Set to false for recommendation-only mode."
  default     = false
}
